...
phot3 = Photon2(Vector(500,0),Vector(1,0),300)
phot4 = Photon2(Vector(500,100),Vector(1,0),100)
...
def draw():
    ...
    fill(0)
    Text("Monochromatic",(-400,420),size =45)
    Text("Not Monochromatic",(420,420),size =45)
